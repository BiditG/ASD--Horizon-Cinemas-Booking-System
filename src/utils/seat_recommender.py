        ...
        for s in cand:
            ...
            if left_col >= 0:
                ...
                if left_free and not left_in_cand:
                    ...
                    if far_left_col < 0 or not any(cs["row"] == s["row"] and cs["col"]
                                                   == far_left_col and cs["is_free"] for cs in all_seats):
            ...
            if right_col < 10:
                ...
                if right_free and not right_in_cand:
                    ...
                    if far_right_col >= 10 or not any(
                            cs["row"] == s["row"] and cs["col"] == far_right_col and cs["is_free"] for cs in all_seats):
